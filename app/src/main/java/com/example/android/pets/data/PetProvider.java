...
public class PetProvider extends ContentProvider {
    ...
    static {
        // Setup the UriMatcher with the URI patterns your ContentPtovider will accept and assign each
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case PET_ID:
                ...
                //
                // ContentUris.parseId(uri): extract URI, this converts last segment of URI into long,
                // and then we turn it into string using:  String.valueOf() method.
    ...
    private Uri insertPet(Uri uri, ContentValues values) {
        ...
        // NULL value is allowed (but the database will use a default of 0 if a value isn't provided). Also, must be a positive value.
