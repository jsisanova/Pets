...
public class EditorActivity extends AppCompatActivity implements
     ...
     * To show the “Discard changes” dialog only if the user changed one of the parts of the form.
     */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (mCurrentPetUri == null) {
            // This is a new pet, so change the app bar (label) to say "Add a Pet"
